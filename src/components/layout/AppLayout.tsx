...
const navItems = [
  ...
  { path: '/analytics', icon: BarChart3, label: 'Analityka' },
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-card/95 backdrop-blur-lg">
        <div className="mx-auto flex max-w-lg items-center justify-around px-1 py-2">
          ...
          <button
            onClick={() => signOut()}
            className="flex flex-col items-center gap-0.5 rounded-lg px-2 py-1.5 text-muted-foreground transition-all hover:text-destructive"
          >
